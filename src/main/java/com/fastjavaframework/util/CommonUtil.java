...
public class CommonUtil {
	...
	public static Object setDefValue(Class clz, Class genericityClz) {
		...
		if(clzName.equals(Object.class.getName())) {
			...
			return true;
					...
					byte.class.getName().equals(clzName) || short.class.getName().equals(clzName) ||
					int.class.getName().equals(clzName) || long.class.getName().equals(clzName)) {
			return 0;
	...
	public static boolean isModel(String classStr) {
		if(!byte.class.getName().equals(classStr) && !short.class.getName().equals(classStr)
			&& !int.class.getName().equals(classStr) && !long.class.getName().equals(classStr)
			&& !float.class.getName().equals(classStr) && !double.class.getName().equals(classStr)
			&& !boolean.class.getName().equals(classStr) && !char.class.getName().equals(classStr)) {
			return true;
		}
